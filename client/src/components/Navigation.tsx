        ...
        <div className="flex items-center justify-between h-14 sm:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 border-2 border-primary text-primary hover:bg-primary hover:text-white font-display font-bold tracking-wider text-sm transition-all shadow-[0_0_12px_rgba(0,122,255,0.3)] hover:shadow-[0_0_20px_rgba(0,122,255,0.5)]"
            >
          ...
          <div className="container py-3">
            ...
            <div className="pt-3 space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 border-2 border-primary text-primary font-display font-bold tracking-wider text-sm hover:bg-primary hover:text-white transition-all shadow-[0_0_12px_rgba(0,122,255,0.3)] hover:shadow-[0_0_20px_rgba(0,122,255,0.5)]"
              >
                <Phone className="w-4 h-4" />
                {isSpanish ? "LLAMAR" : "CALL NOW"}
              </button>
