                  ...
                  <div className="absolute top-full left-0 mt-1 bg-secondary border border-border shadow-2xl z-[9999] min-w-[420px]">
                    <div className="p-2 grid grid-cols-2 gap-2">
                      ...
                      >
                        ...
                        <span className="flex items-start gap-1.5 text-xs text-muted-foreground leading-tight">
              ...
              {mobileServiceOpen && (
                <div className="py-2 border-b border-border/30 grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <span className="flex items-start gap-1 text-[10px] text-muted-foreground leading-tight">
