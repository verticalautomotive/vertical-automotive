        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex items-baseline gap-3 mb-8">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm text-muted-foreground ml-1">4.9 · 500+ reviews</span>
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {reviews.map((review, i) => (
              <div key={i} className="bg-secondary border border-border p-5 flex flex-col gap-3">
                <div className="flex items-center gap-1">
                  {[1,2,3,4,5].map((s) => (
                    <Star key={s} className="w-3.5 h-3.5 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
                <p className="text-sm text-secondary-foreground/80 leading-relaxed flex-1">
                  "{review.text}"
                </p>
          ...
          <div className="mt-6 text-center">
            <a
              href="https://www.google.com/maps/place/Vertical+Automotive"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-primary font-display font-bold tracking-wider hover:underline"
            >
