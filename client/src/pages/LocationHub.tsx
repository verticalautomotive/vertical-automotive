...
const ALL_SERVICES = [
  ...
  { slug: "wheel-alignment",          name: "Wheel Alignment & Tires",             nameEs: "Alineación y Llantas",               shortTitle: "Alignment",        shortTitleEs: "Alineación",        icon: "circle" },
  ...
  { slug: "tire-service",             name: "Tire Service & Replacement",          nameEs: "Servicio y Cambio de Llantas",        shortTitle: "Tires",            shortTitleEs: "Llantas",           icon: "circle" },
];
...
const FORT_LAUDERDALE_DATA: LocationData = {
  ...
  aboutParagraphEs: "Vertical Automotive en Fort Lauderdale está en 707 NE 11th Street — a minutos de Victoria Park, Las Olas y Flagler Village. Nuestros técnicos certificados ASE se especializan en Tesla, Europeos, Asiáticos y Domésticos, con diagnósticos de nivel de concesionario a precio de taller independiente. Desde cambios de aceite hasta reconstrucciones de transmisión, cada reparación tiene garantía de 36 meses / 36,000 millas. Llevamos sirviendo al Condado Broward desde 1989 con presupuestos honestos, sin cobros de más y servicio el mismo día en la mayoría de los trabajos.",
  photos: [
...
const WILTON_MANORS_DATA: LocationData = {
  ...
  aboutParagraphEs: "Vertical Automotive en Wilton Manors, en 1100 W Oakland Park Blvd, ha sido el taller de confianza para conductores de Oakland Park, Sunrise y Lauderdale Lakes desde 1989. Nuestro equipo certificado ASE maneja todo, desde diagnósticos de batería Tesla hasta reconstrucciones de transmisión europea — con herramientas de escaneo de nivel de fábrica y precios transparentes. Cada reparación tiene garantía de 36 meses / 36,000 millas, e incluimos inspecciones multipunto gratis en cada visita. Sin cobros de más, sin sorpresas — solo trabajo bien hecho desde la primera vez.",
  photos: [
  ...
  reviews: [
    { name: "Robert H.", rating: 5, text: "I've been bringing my cars here since 2018. Best shop in Wilton Manors by far. They know European cars — my Volvo is always in great hands.", textEs: "Llevo trayendo los carros aquí desde 2018. El mejor taller en Wilton Manors, sin duda. Conocen los carros europeos — el Volvo siempre queda en buenas manos.", date: "2025" },
    { name: "Lisa P.", rating: 5, text: "Took my Prius in for a strange noise. They found the issue in 20 minutes, fixed it same day. Very honest — didn't try to upsell me on anything.", textEs: "Llevé el Prius por un ruido extraño. Encontraron el problema en 20 minutos y lo arreglaron el mismo día. Muy honestos — no te meten cosas de más.", date: "2025" },
    { name: "Marcus W.", rating: 5, text: "Had a full brake job done on my F-150. Price was fair, work was excellent, and they finished ahead of schedule. Will be back for everything.", textEs: "Le hicieron los frenos completos al F-150. El precio fue justo, el trabajo excelente y lo tuvieron listo antes de lo esperado. Vuelvo para todo.", date: "2024" },
    { name: "Diana F.", rating: 5, text: "My Honda's AC stopped working in August. Vertical Automotive on Oakland Park got me in immediately and fixed it the same day. Lifesavers!", textEs: "Se me dañó el A/C del Honda en agosto. Vertical Automotive en Oakland Park me dieron cita de inmediato y lo arreglaron el mismo día. ¡Los mejores!", date: "2024" },
    { name: "Tom B.", rating: 5, text: "These guys are the real deal. Diagnosed a transmission issue that the dealer missed. Saved me over $1,000. Honest and skilled.", textEs: "Estos son los buenos de verdad. Le diagnosticaron un problema de transmisión que el concesionario no encontró. Me ahorraron más de $1,000. Honestos y saben lo que hacen.", date: "2025" },
    { name: "Natalie C.", rating: 5, text: "Clean shop, friendly staff, and they explain everything clearly. My whole family brings their cars here now. Wouldn't go anywhere else.", textEs: "Taller limpio, buen trato y te explican todo bien claro. Toda la familia trae los carros aquí ahora. No vamos a ningún otro lado.", date: "2024" },
  ],
