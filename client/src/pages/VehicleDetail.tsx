...
export default function VehicleDetail() {
  ...
  const vehicleSEOMap: Record<string, VehicleSEO> = {
    "tesla-vehicles-service": {
      ...
      ogImage: "/img/tesla-diagnostics_7906cd95.webp",
