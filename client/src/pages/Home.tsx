  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(to right, rgba(20, 20, 30, 0.95) 0%, rgba(20, 20, 30, 0.7) 50%, rgba(20, 20, 30, 0.4) 100%), url('https://private-us-east-1.manuscdn.com/sessionFile/zG7TkjTFYQTi6RlHwEX5Va/sandbox/4uoMfJPiYSKA2driFpoMoI-img-1_1771025930000_na1fn_aGVyby13b3Jrc2hvcA.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=lLbiZuzNkN37dsFohYNsw5qk0CP9PEUwIbB7bHt4YNgq7MKyuYM3qL5suTirwqaZIQRBe9C2dM5ZathkpM6nrglvjsaq~F~zqQnORoEhqRs7vaiF-m2ic6IqTVkRBpErgUvcxFBH9L8HjdjlgMGpITBUSKmYtgbosZ0CRTLuOuYVAZScBLKjk9G16DuG-x1mbIBcBBGzRs~fTU9DFl3oQDQbdIG6Q~DUErbgqDHTp-Zw1cxBhpIJFEvBTz3D5zfnlCtQ9q0Hp37HvEGmYwsd1HSBFgr9MbUHju7z--scAWQ2HyvI8bmCi6DhcQj0b0GB~zKw~jZrCYR3g9HMfGQBEg__')`,
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {vehicleTypes.map((type, index) => (
              <div
                key={index}
                className="group relative aspect-square overflow-hidden bg-card hover:shadow-2xl transition-all duration-300"
                style={{
